...
--
-- NOTA (auditoria 2026-05-23): este ficheiro estava aplicado no remoto mas em
-- falta no repositório (drift). Recuperado de supabase_migrations para repor o
-- repo como fonte de verdade. Ver migração 0011 e a memória de migration-drift.
-- ============================================================================
...
alter table public.faturacao
  add constraint faturacao_aluno_mes_disciplina_unique
